...
plt_brain(plane = "transverse", k = 45, mask=mask)
```

#### Saggital Plane

```{r echo = FALSE, fig.align="center"}
plt_brain(plane = "saggital", k = 45, mask=mask) + labs(x="y", y="z")
```

#### Coronal Plane

```{r echo = FALSE, fig.align="center"}
plt_brain(plane = "coronal", k = 45, mask=mask) + labs(y="z")
```
